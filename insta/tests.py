...
from .models import Image,Follow,Profile,Comment
...
class ImageTestClass(TestCase):
    ...
    def setUp(self):
        ...
        self.user1 = User(username='coco')
        self.user1.save()
        
        
        self.image=Image(imageName='leaves',imageCaption='beautiful',image='insta.png',likes="1")
    ...
    def get_image_by_id(self):
        ...
        image=Image.objects.filter(name=self.image.id)
